...
with open(os.path.join('\MyDocuments\Python Scripts','fresh-list'), "r") as r:
	for line in r:
		...
		if ap_name_4 == "bd1w":
			print ("config ap group-name BRD-floor-1-apg %s" %(line))
			r_list.clear()
		elif ap_name_4 == "bd2w":
			print ("config ap group-name BRD-floor-2-apg %s" %(line))
			r_list.clear()
		elif ap_name_4 == "bd2w" or ap_name_4 == "bscw":
			print ("config ap group-name BRD-floor-2-apg %s" %(line))
			r_list.clear()			
		elif ap_name_4 == "bd3w":
			print ("config ap group-name BRD-floor-3-apg %s" %(line))
			r_list.clear()
		elif ap_name_4 == "bd4w":
			print ("config ap group-name BRD-floor-4-apg %s" %(line))
			r_list.clear()
		elif ap_name_4 == "bd5w":
			print ("config ap group-name BRD-floor-5-apg %s" %(line))
			r_list.clear()
		elif ap_name_4 == "bd6w":
			print ("config ap group-name BRD-floor-6-apg %s" %(line))
			r_list.clear()
		elif ap_name_4 == "bd7w":
			print ("config ap group-name BRD-floor-7-apg %s" %(line))
			r_list.clear()	
		elif ap_name_5 == "brd07":
			print ("config ap group-name BRD-floor-7-apg %s" %(line))
			r_list.clear()					
		elif ap_name_4 == "bdbw":
			print ("config ap group-name BRD-floor-0-apg %s" %(line))
			r_list.clear()
		elif ap_name_4 == "cp1w" or ap_name_4 == "en1w":
			print ("config ap group-name CEN-floor-1-apg %s" %(line))
			r_list.clear()			
		elif ap_name_4 == "cp2w" or ap_name_4 == "en2w":
			print ("config ap group-name CEN-floor-2-apg %s" %(line))
			r_list.clear()
		elif ap_name_4 == "cp3w" or ap_name_4 == "en3w":
			print ("config ap group-name CEN-floor-3-apg %s" %(line))
			r_list.clear()
		elif ap_name_4 == "cp4w" or ap_name_4 == "en4w":
			print ("config ap group-name CEN-floor-4-apg %s" %(line))
			r_list.clear()
		elif ap_name_4 == "ed2w":
			print ("config ap group-name EDC-floor-2-apg %s" %(line))
			r_list.clear()
		elif ap_name_4 == "ep1w":
			print ("config ap group-name EPL-floor-1-apg %s" %(line))
			r_list.clear()
		elif ap_name_4 == "ep2w":
			print ("config ap group-name EPL-floor-%s-apg %s" %(r_list[2],line))
			r_list.clear()	
		elif ap_name_4 == "ep3w":
			print ("config ap group-name EPL-floor-%s-apg %s" %(r_list[2],line))
			r_list.clear()	
			...
			print ("config ap group-name FLT-floor-%s-apg %s" %(r_list[2],line))
			r_list.clear()
		elif ap_name_4 == "fl3w":
			print ("config ap group-name FLT-floor-%s-apg %s" %(r_list[2],line))
			r_list.clear()		
			...
			print ("config ap group-name GPL-floor-%s-apg %s" %(r_list[2],line))
			r_list.clear()		
		elif ap_name_4 == "mc1w":
			print ("config ap group-name MCL-floor-%s-apg %s" %(r_list[2],line))
			r_list.clear()			
		elif ap_name_4 == "mc2w":
			print ("config ap group-name MCL-floor-%s-apg %s" %(r_list[2],line))
			r_list.clear()
			...
			print ("config ap group-name MCL-floor-0-apg %s" %(line))
			r_list.clear()	
		elif ap_name_4 == "md1w":
			print ("config ap group-name PTK-floor-%s-apg %s" %(r_list[2],line))
			r_list.clear()
		elif ap_name_4 == "md2w":
			print ("config ap group-name PTK-floor-%s-apg %s" %(r_list[2],line))
			r_list.clear()			
		elif ap_name_4 == "mdbw":
			print ("config ap group-name PTK-floor-0-apg %s" %(line))
			r_list.clear()
		elif ap_name_4 == "mp1w":
			print ("config ap group-name MPL-floor-%s-apg %s" %(r_list[2],line))
			r_list.clear()		
		elif ap_name_4 == "mp2w":
			print ("config ap group-name MPL-floor-%s-apg %s" %(r_list[2],line))
			r_list.clear()
			...
			print ("config ap group-name SHP-floor-%s-apg %s" %(r_list[2],line))
			r_list.clear()	
		elif ap_name_4 == "sh2w":
			print ("config ap group-name SHP-floor-%s-apg %s" %(r_list[2],line))
			r_list.clear()
			...
			print ("config ap group-name SMT-floor-%s-apg %s" %(r_list[2],line))
			r_list.clear()
		elif ap_name_4 == "sm2w":
			print ("config ap group-name SMT-floor-%s-apg %s" %(r_list[2],line))
			r_list.clear()
			...
			print ("config ap group-name SMT-floor-0-apg %s" %(line))
			r_list.clear()						
		elif ap_name_4 == "wp1w" or ap_name_4 == "jmcw":
			print ("config ap group-name WPL-floor-%s-apg %s" %(r_list[2],line))
			r_list.clear()
		elif ap_name_4 == "wp2w":
			print ("config ap group-name WPL-floor-%s-apg %s" %(r_list[2],line))
			r_list.clear()		
